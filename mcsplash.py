#TODO: Add:
    #Bedrock Splash Texts
    #PE Splash Texts
    #Education Edition Splashes

import random
import tkinter

splash=[
    #These are all of the splash texts in Minecraft: Java Edition as of ver. 1.19.4
    "As seen on TV!",
    "Awesome!",
    "100% pure!",
    "May contain nuts!",
    ...
    #These are just some extra splashes I added for fun :)
    "Completely Original!",
    "Extra Fries!",
    "Have a nice day!",
    "You got any games on your PC?",
    "Hydrate! NOW!",
    "Also try ULTRAKILL!",
    "Also try Muse Dash!",
    "Also try Wordle!",
    "Also try NationStates!",
    "Also try Your Only Move Is HUSTLE!",
    "Speling errors!",
    #Yay! You found the secret splash!
    "Make sure to touch grass!",
    "Am I added to startup?",
    "Now on Linux!",
    "Now on GitHub!"
    "Now on Snap!"
    "Woo, askubuntu!",
    ...
    "Pootis!",
    "Today's splash text is sponsored by Raid: Shadow Legends!",
    "Today's splash text is sponsored by NordVPN!",
    "Today's splash text is sponsored by Displate!",
    "Don't do school, eat your drugs, stay in vegetables!",
    "Don't do drugs, eat your vegetables, stay in school!",
    "Don't do vegetables, eat your school, stay in drugs!",
    ...
    "Mom, Phineas & Freb are making Minecraft splash text parodies!",
    "Gitchie Gitchie Goo!",
    "Bandit!",
    "Chili!",
    "Bingo!",
    "Bluey!",
    "R.I.P. Vine",
    "Hi welcome ot Chili's!",
    "It is Wednesday, my dudes!",
    "Hail Kyenschlovia!",
    "Not all furries are bad!",
    "Cats Rule!",
    "Dogs Rule",
    "This splash text is still being ty",
    "#SaveTF2!",
    "When life gives you trash, become a racoon.",
    "AAAAAAAAAAAAAAAAAAAAAA",
    "Out-pizza's the Hut!",
    "Do are you has stupid?",
]
